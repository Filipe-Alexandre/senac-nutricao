export default function Videos() {
  return (
        <section id="videos">
            ...
            <ul>
                <li>Trocas inteligentes para reduzir calorias sem passar fome.</li>
                <li>Montagem do prato equilibrado (metade vegetais).</li>
                <li>Alimentos aliados: fibras, proteínas magras, frutas inteiras.</li>
            ...
            <h4>Tópicos abordados:</h4>
            <ul>
                <li>Onde está o sal escondido e como reduzir.</li>
                <li>Trocas para diminuir sódio (ervas, alho, limão).</li>
                <li>Alimentos que ajudam a controlar a pressão.</li>
            ...
            <h4>Tópicos abordados:</h4>
            <ul>
                <li>O que mais eleva a glicemia no dia a dia.</li>
